...
try:
    ...
    print(f'A divisão dos numeros {num_1} e {num_2} corresponde a {num_1/num_2}')
    print(f'O soma dos numeros {num_1} e {num_2} corresponde a {num_1+num_2}')
    print(f'O subtração dos numeros {num_1} e {num_2} corresponde a {num_1-num_2}')
